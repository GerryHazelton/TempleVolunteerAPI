...
namespace TempleVolunteerAPI.Repository
{
    public interface IRepositoryBase<T> where T : class
    {
        ...
        Task<RepositoryResponse<T>> RecordLoginAttempts(string userId, int propertyId);
        Task<RepositoryResponse<T>> ResetLoginAttempts(string userId, int propertyId);
        Task<RepositoryResponse<T>> LogError(LogErrorParms parms);
    }
}

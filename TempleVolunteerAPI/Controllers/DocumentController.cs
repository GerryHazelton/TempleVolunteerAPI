...
namespace TempleVolunteerAPI.API
{
    ...
    public class DocumentController : ControllerBase
    {
        ...
        [HttpGet("GetAllAsync")]
        public async Task<ServiceResponse<IList<DocumentRequest>>> GetAllAsync([FromBody] MiscRequest request)
        {
        ...
        public async Task<ServiceResponse<DocumentResponse>> GetByIdAsync(MiscRequest request)
        {
            _response.Data = _mapper.Map<DocumentResponse>(await _documentService.GetAsync(request.GetById, request.PropertyId, request.UserId));
